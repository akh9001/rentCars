...
function Register() {
  ...
  return (
    <div className='bg-[#F2F2F2]'>
      <LightNavBar/>
      <div className="min-h-screen bg-[#F2F2F2] p-2 md:p-3 lg:grid lg:grid-cols-2 items-center content-center 	lg:gap-2 gap[0.25rem] py-5">
        
        <div className='lg:max-h-screen lg:flex hidden lg:pl-[11rem]'>
            <img
            src={carpicture}
              alt=""
          className='lg:rounded-lg w-full h-[90vh] object-cover'
              />
        </div>
