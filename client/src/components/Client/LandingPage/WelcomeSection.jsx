...
const WelcomeSection = () => {
  return (
    <div className="flex justify-center items-center flex-col bg-black text-white large:py-16 py-16 text-center">
     <div className="absolute top-32 z-30 text-5xl font-extrabold mb-8 p-8 rounded-md">
